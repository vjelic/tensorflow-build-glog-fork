...
docker run --name tf -w /tf/tensorflow -it -d -v "/tmp/packages:/tf/pkg" -v "/home/furmanek/WORK/framework/tensorflow/5.2/develop-upstream/tensorflow-upstream:/tf/tensorflow" -v "/tmp/bazelcache:/tf/cache" my-tf-devel:latest bash
